...
public class DBUtil {
	...
	// across methods, also make sure there is only one connection
	...
	public static Connection makeConnection() {
		...
		if (conn == null) {
			try {
				conn = DriverManager.getConnection("jdbc:postgresql://localhost:5432/postgres", "ProjectZeroGJ", "postgres");
